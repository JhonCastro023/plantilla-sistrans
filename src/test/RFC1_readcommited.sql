...
-- Versión con nivel de aislamiento READ COMMITTED
-- Incluye una pausa de 30 segundos entre dos ejecuciones para observar concurrencia
...
-- Segunda ejecución (para observar non repeatable reads o phantoms)
SELECT
  s.ID AS SOLICITUD_ID,
  v.ID AS VIAJE_ID,
  s.SOLICITADO_EN,
